...
plot(x=perAA,y=underCountPerCent,main="%vote undercount with percentage of African - American Population",col="black",pch=19)

plot(x=perAA,y=underCountPerCent,main="%vote undercount with percentage of African - American Population",pch=19,col=c("black","red","yellow","green")[equip],xlab="African-American Population",ylab="Undercount % ")
